	...
	page: {
		main: function main() {
			...
			(0, _jquery2.default)(document).on({
				...
				'blur': function blur() {
					var this_fields = (0, _jquery2.default)(this),
					    proxynonce = (0, _jquery2.default)('#proxynonce').text(),
					    nameserver = this_fields.val(),
					    next_ip_field = (0, _jquery2.default)(':input:eq(' + ((0, _jquery2.default)(':input').index(this_fields) + 1) + ')'),
					...
					if (nameserver.length > 0 && next_ip_field.val().length === 0) {
						...
						_jquery2.default.getJSON(get_ip, function (data) {
							// if we don't have a nonce problem, continue
							if (data != '-1' && data != '') {
								var index,
								    api_ns,
								    len = data.result.length,
								    wrapper = (0, _jquery2.default)('.js-input-nameserver-wrap'); // Nameservers field wrapper;
									...
									if (index in data.result) {
										...
										if (index === 0) {
											...
											var data = {
												...
												'ns': nameserver,
												'ip': ip_address,
												'nonce': (0, _jquery2.default)('#proxynonce').text()
											};
											// Post the AJAX query to Zonemaster class
											_jquery2.default.post('/', data, function (response) {

												if (response != '' && response != '-1') {
													var responseData = _jquery2.default.parseJSON(response);
													(0, _jquery2.default)('.ns-error').remove();
													(0, _jquery2.default)(wrapper).append(responseData);
												} else {
													(0, _jquery2.default)(wrapper).append('<span class="label alert fade-in fast ns-error">' + zmDefs.error_text + '</span>');
												}
											});
										}
									}
								...
								if (debug === 'yes') {
									console.log('Check ip for nameserver: Nonce is not working or server is offline This is current nonce: ' + (0, _jquery2.default)('#proxynonce').text());
								}
							}
						});
					}
			...
			(0, _jquery2.default)(document).on({
				...
				'blur': function blur() {
					var this_field = (0, _jquery2.default)(this),
					    nameserver = (0, _jquery2.default)(':input:eq(' + ((0, _jquery2.default)(':input').index(this_field) - 1) + ')'),
					    debug = 'no';

					debug = zmDefs.debug;
					// remove if previous errors
					(0, _jquery2.default)('.js-show-error').remove();
					...
					if (this_field.val() !== '') {
						...
						if (re.exec(teststring) === null) {
							...
							this_field.select();
							if (debug === 'yes') {
								console.log('wrong ip-address : ' + this_field.val());
							}
						}
					}
				}
			...
			(0, _jquery2.default)(document).on({
				...
				'click': function click(e) {
					e.preventDefault();
					var this_zone = (0, _jquery2.default)('#zone_tld_pre_delegated').val(),
					    data = {
					...
					debug = zmDefs.debug;
					if (debug === 'yes') {
						console.log('Trying to get parent zone data for : ' + this_zone);
					}

					if ('' == this_zone) {
						(0, _jquery2.default)('.js-pre-zone-required').prepend(' <span class="label warning fade-in fast">' + zmDefs.required_text + '</span> ');
						(0, _jquery2.default)('#zone_tld_pre_delegated').focus();
					} else {

						(0, _jquery2.default)('.js-input-nameserver-wrap').prepend('<span class="label info fade-in fast js-parent-fetching">' + zmDefs.fetching_data + '</span>');

						// Post the AJAX query
						_jquery2.default.post('/', data, function (response) {

							(0, _jquery2.default)('.js-parent-fetching').remove();

							if (response != '-1' && response != '') {

								var nameservers_html = (0, _jquery2.default)(response).find('#nameservers_html').html(),
								    digests_html = (0, _jquery2.default)(response).find('#digests_html').html();

								// Remove previous fields and ...
								(0, _jquery2.default)('.js-input-nameserver-wrap').empty();
								(0, _jquery2.default)('.js-input-ds-list').empty();
								// .. add prefilled fields from backend
								(0, _jquery2.default)('.js-input-nameserver-wrap').append(nameservers_html);
								(0, _jquery2.default)('.js-input-ds-list').append(digests_html);
							} else {
								(0, _jquery2.default)('.js-input-nameserver-wrap').prepend('<span class="label alert fade-in fast">' + zmDefs.error_parent + '</span>');
							}
						});
					}
				}
			...
			(0, _jquery2.default)('.js-check-ipv4').click(function () {
				(0, _jquery2.default)('.js-check-ipv6').not(':checked').prop('checked', true);
			});
			(0, _jquery2.default)('.js-check-ipv6').click(function () {
				(0, _jquery2.default)('.js-check-ipv4').not(':checked').prop('checked', true);
			});

			// add or remove fields for nameservers
			var max_fields = 30,
			    // maximum nameservers allowed
			wrapper = (0, _jquery2.default)('.js-input-nameserver-wrap'),
			    // Nameservers field wrapper
			add_button = (0, _jquery2.default)('.js-add-nameserver-button'),
			    // Add Nameservers button
			copy_ns_html = (0, _jquery2.default)('#nameservers_html').html(),
			    // html for duplication
			...
			add_button.click(function (e) {
				...
				if (x < max_fields) {
					...
					(0, _jquery2.default)(wrapper).append(copy_ns_html); //add input box
				} else {
					// no more fields
					(0, _jquery2.default)(add_button).hide();
				}
			});

			wrapper.on('click', '.js-remove-nameservers', function (e) {
				//user click on remove button
				e.preventDefault();

				(0, _jquery2.default)(this).closest('.js-ns-container').remove();x--;
				(0, _jquery2.default)(add_button).show();
			});

			// add or remove fields for digests
			var ds_wrapper = (0, _jquery2.default)('.js-input-ds-list'),
			    ds_add_button = (0, _jquery2.default)('.js-digest-button'),
			    copy_ds_html = (0, _jquery2.default)('#digests_html').html();

			ds_add_button.click(function (e) {
				e.preventDefault();
				(0, _jquery2.default)(ds_wrapper).append(copy_ds_html);
			});

			ds_wrapper.on('click', '.js-remove-digests', function (e) {
				//user click on remove button
				e.preventDefault();
				(0, _jquery2.default)(this).closest('.js-digest-container').remove();
			});

			// Submit the simple domain check form
			(0, _jquery2.default)(document).on('submit', 'form.js-domain-check', function (e) {
				e.preventDefault();
				// empty the address field
				history.pushState('', document.title, location.pathname);
				// modify lang url
				var langurl = (0, _jquery2.default)('.lang-item a').attr('href');

				if (langurl !== undefined) {
					langurl = langurl.split("?")[0];
					(0, _jquery2.default)('.lang-item a').attr('href', langurl);
				}

				var $form = (0, _jquery2.default)('.js-domain-check'),
				    term = (0, _jquery2.default)('#zone_tld_domain_check').val(),
				    ipv4 = 0,
				    ipv6 = 0;
				if ((0, _jquery2.default)('#check_ip_v4_domain_check').is(':checked')) {
					ipv4 = 1;
				}
				if ((0, _jquery2.default)('#check_ip_v6_domain_check').is(':checked')) {
					ipv6 = 1;
				}
			...
			(0, _jquery2.default)(document).on('keypress', 'form.js-pre-delegated-check input[type="text"], form.js-pre-delegated-check input[type="checkbox"]', function (e) {
				if (e.which == 13) {
					(0, _jquery2.default)(e.target);

					var $targ = (0, _jquery2.default)(e.target),
					    debug = 'no';

					debug = zmDefs.debug;
					if (debug === 'yes') {
						console.log('Enter detected for target: ' + $targ);
					}

					if (!$targ.is(':button,:submit')) {

						var focusNext = false;
						(0, _jquery2.default)(document).find(':input:visible').each(function () {
			...
			(0, _jquery2.default)(document).on('submit', 'form.js-pre-delegated-check', function (e) {
				e.preventDefault();
				...
				var $form = (0, _jquery2.default)('.js-pre-delegated-check'),
				    term = (0, _jquery2.default)('#zone_tld_pre_delegated').val(),
				    ipv4 = 0,
				    ipv6 = 0,
				    nameservers = [],
				    ip_addresses = [],
				...
				if ((0, _jquery2.default)('#check_ip_v4_predelegated').is(':checked')) {
					ipv4 = 1;
				}
				if ((0, _jquery2.default)('#check_ip_v6_predelegated').is(':checked')) {
					ipv6 = 1;
				}
				// nameserver fields
				(0, _jquery2.default)('.js-field-blur').each(function (index) {
					nameservers.push((0, _jquery2.default)(this).val());
				});
				(0, _jquery2.default)('.js-field-ip').each(function (index) {
					ip_addresses.push((0, _jquery2.default)(this).val());
				});

				// digests fields
				(0, _jquery2.default)('.js-key-tag').each(function (index) {
					keytag.push((0, _jquery2.default)(this).val());
				});
				(0, _jquery2.default)('.js-digest-type').each(function (index) {
					digtype.push((0, _jquery2.default)(this).val());
				});
				(0, _jquery2.default)('.js-digest').each(function (index) {
					digest.push((0, _jquery2.default)(this).val());
				});
				(0, _jquery2.default)('.js-algorithm').each(function (index) {
					algorithm.push((0, _jquery2.default)(this).val());
				});
			...
			(0, _jquery2.default)(document).on('click', 'a.js-disabled', function (e) {
				e.preventDefault();
			});
			...
			function post_form(term, ipv4, ipv6, form_class, nameservers, ip_addresses, keytag, digtype, digest, algorithm) {
				...
				(0, _jquery2.default)('html,body').animate({ scrollTop: (0, _jquery2.default)('#domain_check-label').offset().top }, 1000);
				(0, _jquery2.default)('.fade-in.fast.warning, .fade-in.fast.alert').hide();

				(0, _jquery2.default)('#singletest, #resultsarea, #progressarea, #errorurl').empty();
				(0, _jquery2.default)('.js-domain-check .text-center.lead, .js-pre-zone-required').append('<span class="label info fade-in fast start-test">' + zmDefs.start_test + '</span>');

				(0, _jquery2.default)('input, button, option').prop('disabled', true);
				(0, _jquery2.default)('a').not('a.js-cancel').addClass('js-disabled');

				// Send the data using post to page-start.php - yes simple :)
				var posting = _jquery2.default.post('/', {
					zone_tld: term,
					check_ip_v4: ipv4,
					check_ip_v6: ipv6,
					...
					tld_zonemaster: (0, _jquery2.default)('#tld_zonemaster').val(),
					cache: true
				});
				...
				posting.done(function (data) {
					...
					var apianswer = (0, _jquery2.default)(data).find("#apianswer").text(),
					    proxynonce = (0, _jquery2.default)(data).find("#proxynonce").text(),
					    errorurl = (0, _jquery2.default)(data).find('#errorurl'),
					    progressarea = (0, _jquery2.default)(data).find('#js-div-report-status').html();
					...
					if (errorurl.length > 0) {
						(0, _jquery2.default)('.test-form').prepend(errorurl);
						(0, _jquery2.default)('.start-test').remove();
						(0, _jquery2.default)('input, button, option').prop('disabled', false);
						(0, _jquery2.default)('a').removeClass('js-disabled');
						(0, _jquery2.default)('#test-result-tab').addClass('hide');
					}

					if (apianswer) {
						var checkstatus = function checkstatus(urltocheck, callback) {
							starttest = false;
							temp = _jquery2.default.getJSON(urltocheck, function (data) {
						...
						var waitandgetresults = function waitandgetresults(urltocheck) {
							...
							checkstatus(urltocheck, function (data) {
								...
								if (data != '-1') {
									...
									if (dataResult <= 99) {
										...
										if (dataResult > 10) {
											(0, _jquery2.default)('#test-result-tab a').text(zmDefs.running_test);
										}

										if (debug === 'yes') {
											console.log('progress: ' + dataResult);
										}

										(0, _jquery2.default)('.progress').attr('aria-valuenow', dataResult);
										(0, _jquery2.default)('.progress').attr('aria-valuetext', dataResult + 'percent');

										(0, _jquery2.default)('.progress-meter').css('width', dataResult + '%');
										(0, _jquery2.default)('.progress-meter-text').text(dataResult + '%');

										// If we get stuck on the same progress, indicate to user
										if (typeof myprogress != 'undefined' && myprogress === dataResult) {
											(0, _jquery2.default)('.progress').removeClass('progress-waiting');
											myprogress = 1 + dataResult;
										} else if (typeof myprogress != 'undefined' && myprogress > dataResult) {
											(0, _jquery2.default)('.progress').addClass('progress-waiting');
										} else {
											(0, _jquery2.default)('.progress').removeClass('progress-waiting');
										...
										(0, _jquery2.default)('.progress').addClass('progress-waiting');
										(0, _jquery2.default)('.progress-meter').attr('aria-valuenow', '100');
										(0, _jquery2.default)('.progress-meter').css('width', '100%');
										(0, _jquery2.default)('.progress-meter-text').text(waitingOnResult);
									...
									clearInterval(interval); // stop the interval
									(0, _jquery2.default)('.js-report-status').stop().hide(function () {
										(0, _jquery2.default)('.start-test').remove();
										(0, _jquery2.default)('input, button, option').prop('disabled', false);
										(0, _jquery2.default)('a').removeClass('js-disabled');
										(0, _jquery2.default)('#test-result-tab').addClass('hide');

										(0, _jquery2.default)('#resultsarea').append('<div class="div-results" id="singletest"><div class="div-tab-area alert"><div class="row"><div class="column"><br><p class="result-text-two">' + zmDefs.error_text + '</p><br></div></div></div></div>');
									});
								}
							});
						};
						...
						debug = zmDefs.debug;
						(0, _jquery2.default)('.js-hide').removeClass('js-hide');
						(0, _jquery2.default)('#singletest, #resultsarea, #progressarea, #errorurl').empty();
						(0, _jquery2.default)('#test-result-tab, #test_progress').removeClass('hide');
						(0, _jquery2.default)('#test-result-tab').trigger("click");
						(0, _jquery2.default)('#test-result-tab a').text(zmDefs.start_test);
						(0, _jquery2.default)('#progressarea').html(progressarea);
						(0, _jquery2.default)('.start-test').remove();
			...
			(0, _jquery2.default)(document).on({
				...
				'click': function click(e) {
					e.preventDefault();
					var thislink = (0, _jquery2.default)(this),
					    testid = thislink.attr('data-testid'),
					    $reveal = (0, _jquery2.default)('#reveal_' + testid),
					    debug = 'no',
					    data = {
					...
					if ($reveal.text() !== '') {
						...
						// Post the AJAX query to Zonemaster class
						var expanding = _jquery2.default.post('/', data, function (response) {

							(0, _jquery2.default)('.js-test-fetching-' + testid).remove();

							// activate foundations js on selected, newly added elements
							var elem_rev = new Foundation.Reveal((0, _jquery2.default)('#reveal_' + testid), {
								hideDelay: 20,
								resetOnClose: true
							});
							$reveal.html(response).foundation('open');

							var elem_tab = new Foundation.Tabs((0, _jquery2.default)('#result-tabs' + testid));
					...
					debug = zmDefs.debug;
					if (debug === 'yes') {
						console.log('expanding test result for : ' + (0, _jquery2.default)(this).attr('data-testid'));
					}
				}
			...
			(0, _jquery2.default)(document).on({
				...
				'click': function click(e) {
					...
					if (thislink.hasClass('in-reveal')) {
						(0, _jquery2.default)('.reveal').animate({ scrollTop: (0, _jquery2.default)(testid).offset().top - 100 }, 1000);
					} else {
						(0, _jquery2.default)('html,body').animate({ scrollTop: (0, _jquery2.default)(testid).offset().top - 36 }, 1000);
					}

					debug = zmDefs.debug;
					if (debug === 'yes') {
						console.log('click btn : ' + testid);
					}
				}
			}, '.js-scroll');
			...
			(0, _jquery2.default)(document).on({
				...
				'click': function click(e) {
					...
					if (thislink.hasClass('reverse')) {
						...
						(0, _jquery2.default)('.js-expand-params').hide('fast');
					} else {
						thislink.addClass('reverse');
						(0, _jquery2.default)('.js-expand-params').removeClass('show-if-no-js');
						(0, _jquery2.default)('.js-expand-params').show('fast');
					}

					debug = zmDefs.debug;
					if (debug === 'yes') {
						console.log('click expand test params');
					}
				}
			}, '.expand-link');
		}
...
_jquery2.default.fn.zonalizer = function (page) {
	zonalizer.page[page]();
	return this;
};
...
},{"./api":1,"foundation-sites":3,"jquery":38}],3:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"jquery":38}],5:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.keyboard":31,"jquery":38}],6:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.keyboard":31,"./foundation.util.nest":34,"jquery":38}],7:[function(require,module,exports){
"use strict";
...
},{"./foundation.util.core":29,"./foundation.util.mediaQuery":32,"jquery":38}],8:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.box":28,"./foundation.util.core":29,"./foundation.util.keyboard":31,"./foundation.util.nest":34,"jquery":38}],9:[function(require,module,exports){
'use strict';
...
},{"./foundation.positionable":17,"./foundation.util.core":29,"./foundation.util.keyboard":31,"./foundation.util.triggers":37,"jquery":38}],10:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.box":28,"./foundation.util.core":29,"./foundation.util.keyboard":31,"./foundation.util.nest":34,"jquery":38}],11:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.imageLoader":30,"./foundation.util.mediaQuery":32,"jquery":38}],12:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.mediaQuery":32,"jquery":38}],13:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.smoothScroll":23,"./foundation.util.core":29,"jquery":38}],14:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.keyboard":31,"./foundation.util.mediaQuery":32,"./foundation.util.triggers":37,"jquery":38}],15:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.imageLoader":30,"./foundation.util.keyboard":31,"./foundation.util.motion":33,"./foundation.util.timer":35,"./foundation.util.touch":36,"jquery":38}],16:[function(require,module,exports){
'use strict';
...
},{"./foundation.util.core":29,"jquery":38}],17:[function(require,module,exports){
'use strict';
...
},{"./foundation.accordion":5,"./foundation.plugin":16,"./foundation.tabs":25,"./foundation.util.core":29,"./foundation.util.mediaQuery":32,"jquery":38}],19:[function(require,module,exports){
'use strict';
...
},{"./foundation.accordionMenu":6,"./foundation.drilldown":8,"./foundation.dropdownMenu":10,"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.mediaQuery":32,"jquery":38}],20:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.mediaQuery":32,"./foundation.util.motion":33,"jquery":38}],21:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.keyboard":31,"./foundation.util.mediaQuery":32,"./foundation.util.motion":33,"./foundation.util.triggers":37,"jquery":38}],22:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.keyboard":31,"./foundation.util.motion":33,"./foundation.util.touch":36,"./foundation.util.triggers":37,"jquery":38}],23:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"jquery":38}],24:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.core":29,"./foundation.util.mediaQuery":32,"./foundation.util.triggers":37,"jquery":38}],25:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.imageLoader":30,"./foundation.util.keyboard":31,"jquery":38}],26:[function(require,module,exports){
'use strict';
...
},{"./foundation.plugin":16,"./foundation.util.motion":33,"./foundation.util.triggers":37,"jquery":38}],27:[function(require,module,exports){
'use strict';
...
},{"./foundation.positionable":17,"./foundation.util.core":29,"./foundation.util.mediaQuery":32,"./foundation.util.triggers":37,"jquery":38}],28:[function(require,module,exports){
'use strict';
...
},{"jquery":38}],30:[function(require,module,exports){
'use strict';
...
},{"jquery":38}],31:[function(require,module,exports){
/*******************************************
 *                                         *
...
},{"./foundation.util.core":29,"jquery":38}],32:[function(require,module,exports){
'use strict';
...
},{"jquery":38}],33:[function(require,module,exports){
'use strict';
...
},{"./foundation.util.core":29,"jquery":38}],34:[function(require,module,exports){
'use strict';
...
},{"jquery":38}],35:[function(require,module,exports){
'use strict';
...
},{"jquery":38}],36:[function(require,module,exports){
'use strict';
...
},{"jquery":38}],37:[function(require,module,exports){
'use strict';
...
},{"./foundation.util.motion":33,"jquery":38}],38:[function(require,module,exports){
/*!

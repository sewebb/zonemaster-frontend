...
function zonemaster_scripts() {
	...
	wp_enqueue_style( 'app-css', get_template_directory_uri() . '/css/app.18d6a463.min.css', array(), null, 'all' );

	wp_deregister_script( 'jquery' );
	wp_enqueue_script( 'app-js', get_template_directory_uri() . '/js/app.5338c9c8.min.js', array(), null, true );
